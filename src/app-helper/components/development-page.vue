  ...
  <section id="development-page" :class="{tablet: !isFullFunctional}">
    ...
    <footer>
      <ul class="additional-info">
        ...
        <li><a href="https://github.com/serhiichuk/vue-cli-plugin-clm-helper-up" target="_blank">CLI Plugin Clm Helper</a>
        </li>
        ,
...
<script>
  ...
  import IgnoredSlides from 'vue-cli-plugin-clm-helper-up/lib/sharedUtils/IgnoredSlides'
